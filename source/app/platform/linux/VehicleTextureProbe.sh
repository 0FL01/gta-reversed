...
c++ -std=gnu++23 -O2 -DRW_NULL -ffunction-sections -fdata-sections \
    ...
    "${sdlIncludes[@]/#/-isystem}" \
    gta-reversed/source/app/platform/linux/VehicleTextureProbe.cpp \
    gta-reversed/source/app/platform/linux/VehicleTextureGpuProbe.cpp \
    ...
    -o artifacts/graphics/vehicle-texture-probe
artifacts/graphics/vehicle-texture-probe "${1:-/game}" | tee artifacts/graphics/vehicle-texture-probe.log
